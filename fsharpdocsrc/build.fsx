...
let author = "James Randall"

// Tags for your project (for NuGet package)
let tags = ""

// File system information
let solutionFile  = "FunctionMonkey.sln"
...
let gitOwner = "JamesRandall"
let gitHome = sprintf "%s/%s" "https://github.com/JamesRandall/FunctionMonkey" gitOwner

// The name of the project on GitHub
let gitName = "FunctionMonkey"

// The url for the raw files hosted
let gitRaw = Environment.environVarOrDefault "gitRaw" "https://raw.githubusercontent.com/JamesRandall"

//let website = "/FunctionMonkey"
...
let bin        = __SOURCE_DIRECTORY__ @@ "build.fsxbin"
let content    = __SOURCE_DIRECTORY__ @@ "content"
let output     = __SOURCE_DIRECTORY__ @@ "output"
let files      = __SOURCE_DIRECTORY__ @@ "files"
let templates  = __SOURCE_DIRECTORY__ @@ "tools/templates"
...
let info =
  [ "project-name", "Function Monkey"
    "project-author", "James Randall"
    "project-summary", "Write more functional Azure Functions will the boilerplate taken care of"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/FunctionMonkey.FSharp" ]
...
Target.create "Docs" (fun _ ->
    File.delete "content/release-notes.md"
    Shell.copyFile "content/" "RELEASE_NOTES.md"
    Shell.rename "content/release-notes.md" "content/RELEASE_NOTES.md"

    File.delete "content/license.md"
    Shell.copyFile "content/" "LICENSE.txt"
    Shell.rename "content/license.md" "content/LICENSE.txt"
