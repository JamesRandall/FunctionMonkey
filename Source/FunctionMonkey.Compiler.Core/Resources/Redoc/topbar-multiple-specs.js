...
async function getSpecInfoAsync() {
    return await fetch('./openapi/redoc-documents-spec.json').then(async (response) => {
    ...
    customTopbar.innerHTML =
        `<div class="wrapper">
            <div class="topbar-wrapper">
                <a class="link"><img src="${image}" height="40" /></a>
