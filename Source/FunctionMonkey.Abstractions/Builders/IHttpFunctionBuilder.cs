...
namespace FunctionMonkey.Abstractions.Builders
{
    ...
    {        
        ...
        /// <returns>A IHttpFunctionBuilderMetadataBuilder that allows further HTTP functions to be created and this function to be further configured with Open API / Swagger metadata.</returns>
        IHttpFunctionBuilderMetadataBuilder HttpFunction<TCommand>(AuthorizationTypeEnum authorizationType) where TCommand : ICommand;
        ...
        /// <returns>A IHttpFunctionBuilderMetadataBuilder that allows further HTTP functions to be created and this function to be further configured with Open API / Swagger metadata.</returns>
        IHttpFunctionBuilderMetadataBuilder HttpFunction<TCommand>(AuthorizationTypeEnum authorizationType, params HttpMethod[] method) where TCommand : ICommand;
