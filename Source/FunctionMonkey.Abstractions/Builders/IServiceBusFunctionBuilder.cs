...
namespace FunctionMonkey.Abstractions.Builders
{
    ...
    public interface IServiceBusFunctionBuilder
    {
        ...
        IServiceBusFunctionOptionBuilder QueueFunction<TCommand>(string queueName, bool isSessionEnabled=false) where TCommand : ICommand;
        ...
        /// <returns>A service bus function builder that allows more functions to be created</returns>
        IServiceBusFunctionOptionBuilder SubscriptionFunction<TCommand>(string topicName, string subscriptionName, bool isSessionEnabled=false) where TCommand : ICommand;
    }
}
