...
namespace FunctionMonkey.Abstractions.Builders
{
    public interface ITimerFunctionBuilder
    {
        ...
        IFunctionBuilder Timer<TCommand>(string cronExpression) where TCommand : ICommand;
        ...
        /// <param name="cronExpression">The periodicity of the function</param>
        /// <returns>A function builder</returns>
        IFunctionBuilder Timer<TCommand, TTimerCommandFactoryType>(string cronExpression)
